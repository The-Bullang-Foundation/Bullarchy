...
pub fn required_includes(name: &str, backend: &Backend) -> Vec<&'static str> {
    match (name, backend) {
        ...
        ("open", Backend::C) => vec!["#include <fcntl.h>", "#include <sys/stat.h>", "#include <string.h>"],
        ("replace_str", Backend::C) => vec!["#include <stdlib.h>", "#include <string.h>"],
        ("to_string", Backend::C) => vec!["#include <stdio.h>", "#include <stdlib.h>"],
        ("close", Backend::C) => vec!["#include <unistd.h>"],
        ("ends_with", Backend::C) | ("starts_with", Backend::C) => vec!["#include <string.h>"],
        ("env", Backend::C) => vec!["#include <stdlib.h>"],
        ("exit", Backend::C) => vec!["#include <stdlib.h>"],
        ("len", Backend::C) => vec!["#include <stdint.h>", "#include <string.h>"],
        ("max", Backend::C) | ("min", Backend::C) => vec!["#include <stdint.h>"],
        ("parse_i64", Backend::C) => vec!["#include <stdlib.h>"],
        ("run", Backend::C) => vec!["#include <stdlib.h>"],
        ("sleep", Backend::C) => vec!["#define _DEFAULT_SOURCE", "#include <unistd.h>"],
        ...
        ("open", Backend::Cpp) => vec!["#include <fcntl.h>", "#include <sys/stat.h>", "#include <string>"],
        ("replace_str", Backend::Cpp) => vec!["#include <string>"],
        ("to_string", Backend::Cpp) => vec!["#include <string>"],
        ("close", Backend::Cpp) => vec!["#include <unistd.h>"],
        ("ends_with", Backend::Cpp) | ("starts_with", Backend::Cpp) => vec!["#include <string>"],
        ("env", Backend::Cpp) => vec!["#include <cstdlib>", "#include <string>"],
        ("exit", Backend::Cpp) => vec!["#include <cstdlib>"],
        ("len", Backend::Cpp) => vec!["#include <cstdint>"],
        ("max", Backend::Cpp) | ("min", Backend::Cpp) => vec!["#include <cstdint>", "#include <vector>"],
        ("parse_i64", Backend::Cpp) => vec!["#include <string>"],
        ("run", Backend::Cpp) => vec!["#include <cstdlib>", "#include <string>"],
        ("sleep", Backend::Cpp) => vec!["#include <thread>", "#include <chrono>"],
        _ => Vec::new(),
    }
}
